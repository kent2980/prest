export interface FsstockParamsBase{};

export interface ExplainListParamsInterface extends FsstockParamsBase {
    id: string;
    code: string;
...
interface ExplainItemParamsInterface extends FsstockParamsBase {
...
interface StockBrandsParamsInterface extends FsstockParamsBase{
    code: string;
...
interface StockChartParamsInterface extends FsstockParamsBase{
    /**
     * 銘柄コード
     */
    code: string;
